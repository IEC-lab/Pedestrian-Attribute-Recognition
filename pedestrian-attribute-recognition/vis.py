...
def _get_grad(net, image, class_id=None, conv_layer_name=None, image_grad=False):
    ...
    one_hot_target = mx.nd.one_hot(mx.nd.array([class_id]), 14)
...
def visualize(net, preprocessed_img, orig_img, conv_layer_name):
    ...
    conv_out = get_conv_out_grad(net, preprocessed_img, conv_layer_name=conv_layer_name)
    ...
    return img_ggcam#img_heatmap, img_ggcam, img_ggcam_gray
